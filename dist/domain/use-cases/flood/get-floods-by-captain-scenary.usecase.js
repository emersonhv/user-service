...
exports.GetFloodsByCaptainAndScenary = void 0;
class GetFloodsByCaptainAndScenary {
    constructor(floodRepository) {
        this.floodRepository = floodRepository;
        this.listFloods = [];
    }
    execute(portCaptainId, scenaryId) {
        return __awaiter(this, void 0, void 0, function* () {
            const floods = yield this.floodRepository.getFloodsByCaptainAndScenary(portCaptainId, scenaryId);
...
exports.GetFloodsByCaptainAndScenary = GetFloodsByCaptainAndScenary;
